...
{
    public partial class QaeserCipher : Form
    {
        public QaeserCipher()
        {
            InitializeComponent();
        ...
        private void btn_Encryption_Click(object sender, EventArgs e)
        {
            ...
            txt_CipherText.Text = CipherAlgorthim.Enc_Qaeser(txt_PlainText.Text);
            txt_PlainText.Clear();
        }
        ...
        {
            clsCipherAlgorthim.clsCipherAlgorthims CipherAlgorthim = new clsCipherAlgorthim.clsCipherAlgorthims();
            txt_PlainText.Text = CipherAlgorthim.Dec_Qaeser(txt_CipherText.Text);
