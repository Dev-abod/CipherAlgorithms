...
namespace clsCipherAlgorthims
{
    public class clsCipherAlgorthims
    {
        ...
        public string Enc_Dec_Root13(string PlainText) // هي نفس الكود لتشفير وفك التشفير
        {
            int value;
            string CipherText = string.Empty;
            for (int i = 0; i < PlainText.Length; i++)
        ...
        public string Enc_Dec_Atbash(string PlainText) // هي نفس الكود لتشفير وفك التشفير
        {
            string CipherText = string.Empty;
        ...
        public string Enc_SimpleVengere(string PlainText, string Key)
        {
            string CipherText = string.Empty;
        ...
        public string Dec_SimpleVengere(string CipherText, string Key)
        {
            string PlainText = string.Empty;
            int Value, count = Key.Length;
        ...
        string HSA_Hash(string PlinText)
        {
