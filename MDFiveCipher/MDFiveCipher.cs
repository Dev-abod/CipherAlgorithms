...
namespace MDFiveCipher
{
    public partial class MDFiveCipher : Form
    {
        public MDFiveCipher()
        {
            InitializeComponent();
        ...
        private void btn_Encryption_Click(object sender, EventArgs e)
        {
            ...
            txt_CipherText.Text = CipherAlgorthim.MD5_Hash(txt_PlainText.Text);
            txt_PlainText.Clear();
        }
        ...
        {
            clsCipherAlgorthim.clsCipherAlgorthims CipherAlgorthim = new clsCipherAlgorthim.clsCipherAlgorthims();
            txt_PlainText.Text = CipherAlgorthim.MD5_Hash(txt_CipherText.Text);
